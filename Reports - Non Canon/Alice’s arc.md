...
Alice’s strongest throughline is:
...
### 8. Final choice arc
The endpoint matters: in [[Bonus Track - The Runaway (Reprise)]], Tim leaves and Alice stays. That confirms the broader direction of her narrative. The deepest choice is not between suitors, but between life-paths: conventional departure versus staying with the flock’s social world.

## What works

Alice is an effective entry consciousness. She asks basic questions, misreads things productively, and gives the reader a believable route into the Pillars’ world.

Her arc also aligns well with the book’s major themes:
- participation over spectatorship
- collective life over isolated individuality
- shared Love over possessive intimacy
- art as a social practice, not just a performance

She is especially strong when the novel uses her to dramatize conversion: not religious conversion exactly, but conversion into a new way of feeling, belonging, and moving with others.

## Critique

### 1. Strong milestones, weaker connective tissue
Her major beats are vivid, but sometimes feel episodic. The initiation, selection, belonging, hand-pressing, and drumming milestones are all good, but the manuscript does not always show enough interior continuity between them. She changes meaningfully, but not always with enough on-page processing.

### 2. Musicianship may be underdramatized
Her drumming arc is potentially one of the best developments in the novel, but from the available material it appears more in summary than scene. If this transformation matters, it likely needs more struggle, training, failure, breakthrough, and self-recognition on the page.

### 3. She can feel acted upon
A lot happens *to* Alice: she is chosen, invited, kissed, taught, absorbed. She does make important choices, but surrounding characters often exert more visible force. If you want her to feel fully central, more hinge moments may need to be framed as active decisions rather than receptive transitions.

### 4. The romance web can blur her center
The plural attachments are interesting and thematically apt, but they can also make her feel like a node for others’ desire and jealousy rather than the clear organizer of her own emotional story. That may be intentional, but it risks diluting her agency.

### 5. “Sheltered greenhorn” needs a clearer evolution
That starting point works well early. Later, the manuscript should show more clearly when she stops merely being naïve/open and starts becoming interpretive, skilled, and self-authoring. Otherwise readers may continue to file her under “ingénue” longer than the story wants.

## Bottom line

Alice has a real, multi-part arc:
- first-time seeker
- invited initiate
- flock recruit
- believer in shared Love
- apprentice musician
- chooser of collective belonging over private return

The strongest thematic achievement is that her growth is not just personal confidence; it is a shift in **social imagination**. The main weakness is that some of the transitions between those stages need more interior and dramatic development.

## Notes
- Her Side structure is already legible as progression: Side A makes her a fan; Side B/C deepen her into participant and flock member.
