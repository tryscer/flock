...
POV: Alice
changes:
  - Alice joins Barry, Cindy, Eleanore, and Tim on the trip to the Henrico County Fair for her first live show.
  - Alice learns the group is going to Achievement Day to see the Seven-Tops and the Steam Pillars, while Barry is traveling under cover of a Buzz Cigarettes assignment.
  - Cindy reveals to Alice that she is running away from home.
entities:
  characters:
    - Alice
    - Cindy
